...
torchrun --nnodes=$NNODES \
    ...
    --output_dir ${OUTPUT_DIR}/msmarco_psgs_${PREFIX}_${POOLING_METHOD}_gran_${LMK_GRANULARITY}/ \
    --model_name_or_path ${MODEL_NAME} \
    --train_data ${DATA_DIR}/bge-en-icl/merged_msmarco_psg/ \
    --train_data_config data_configs/msmarco_psg_config.json \
    --learning_rate 2e-5 \
    --bf16 \
