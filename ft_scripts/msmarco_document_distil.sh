...
torchrun --nnodes=$NNODES \
    ...
    --output_dir ${OUTPUT_DIR}/msmarco_docs_${PREFIX}_${POOLING_METHOD}_gran_${LMK_GRANULARITY}/ \
    --model_name_or_path ${MODEL_NAME} \
    --train_data ${DATA_DIR}/bge-en-icl/merged_msmarco/ \
    --train_data_config data_configs/msmarco_doc_config.json \
    --learning_rate 2e-5 \
    --bf16 \
