...
ModernBERT also needs to use a BertDecoderLayer: https://github.com/huggingface/transformers/issues/35385
'''
...
class BertLayerForDecoder(nn.Module):
    def __init__(self, config):
        super().__init__()
        # default BERT configs to use in ModernBERT case
        ...
        if not hasattr(config, "hidden_act"):
            config.hidden_act = getattr(config, "hidden_activation")
