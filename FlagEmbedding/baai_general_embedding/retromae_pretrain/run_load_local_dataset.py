...
from .data import DatasetForPretraining, RetroMAECollator,DatasetForPretrainingLoaded
...
def main():
    ...
    dataset = DatasetForPretrainingLoaded(data_args.train_data)
    #dataset.dataset.save_to_disk("/dccstor/cssblr/vishwajeet/git/2023/FlagEmbedding/data/pre-train/data.hf")
    #dataset = load_from_disk("/dccstor/cssblr/vishwajeet/git/2023/FlagEmbedding/data/pre-train/data.hf")
