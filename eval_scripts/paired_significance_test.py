"""Statistical significance t-test using pytrec_eval."""
...
def main():
    ...
    # Null hypothesis that paired samples have identical values under expectation.
    result = scipy.stats.ttest_rel(first_scores, second_scores)
